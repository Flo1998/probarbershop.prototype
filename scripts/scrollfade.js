let p = document.getElementById('fade')
for(let span of p.children){span.classList.add("scrollFade")}
...
document.addEventListener('DOMContentLoaded', function() {scrollFade()})